...
//! (distprop) matches the true output uncertainty. We build a 2-layer GCN
...
use distprop::burn_sdp::{propagate_linear, propagate_matmul_left, propagate_relu, Moments};
use propago::GCNConv;
